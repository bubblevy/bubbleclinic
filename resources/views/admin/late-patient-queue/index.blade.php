...
<div class="flash-message" data-confirm-patient="@if(session()->has('confirmPatientSuccess')) {{ session('confirmPatientSuccess') }} @endif"></div>
<div class="row">
    ...
    <div class="card h-100">
      <div class="card-header d-flex align-items-center justify-content-between" style="margin-bottom: -0.7rem;">
        ...
        <div class="justify-content-end">
          <!-- Search -->
          <form action="/admin/daftar-antrian-terlambat/search">
          ...
          <div class="table-responsive text-nowrap" style="border-radius: 3px;">
            <table class="table table-striped">
              ...
              <tbody class="table-border-bottom-0">
                ...
                <tr>
                  <td>{{ $patient->name }}</td>
                  <td class="text-center"><span class="badge badge-center bg-info rounded-pill">{{ $patient->late_queue_number }}</span></td>
                ...
                @if($patients->isEmpty())
                <tr>
                  <td colspan="100" class="text-center">Belum ada antrian terlambat hari ini!</td>
                </tr>
                @endif
              </tbody>
            </table>
...
<div class="modal fade" id="confirmQueuePatient" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="/admin/daftar-antrian-terlambat/confirm" method="post" id="formConfirmQueuePatient">
...
@section('script')
<script src="{{ asset('assets/js/queueLatePatient.js') }}"></script>
@endsection
@endsection